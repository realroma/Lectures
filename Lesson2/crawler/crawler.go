...
//Здесь мы принимаем значения и возвращаем два значения.
func Scan(url string, depth int) (data map[string]string, err error) {
	data = make(map[string]string)
//Инициализируем переменную(Или заново переинициализируем[Затеняем]) и передаём в приватную функцию.
...
//Из сылки получаем массив байтов.
